      ...
      <body className="linksPage">
        ...
        <ul listStyleType="none">
          <li >            
            ...
            <span> or WCAG, is the main documentation for all things web accessibility realated.</span>
            </li>
            <li>
            <a href="https://www.deque.com/" target="_blank" role="link">
              Deque  
            </a>
            <span> is a company that has made several accessibility tools and has attempted to make the WCAG a little more reader friendly.</span>
          </li>
          <li>
            WCAG 2.1
            <a
