  ...
  return (
    <div className="main">
      <div id="introduction" className="mainChild commandline">
        <h1>
          Equa11y Command Line Tool: An easy to implement axe-core command line testing tool made by
      ...
      <div className="main-cards">
        <div className="mainChild">
          ...
          <p>
            Equa11y was built from the bottom up with Software Engineers in mind. It was created to
            allow Developers to implement accessibility testing during development and into their
        ...
        <div className="mainChild">
          ...
          <p>
            ...
            and run npx equa11y to get started. Then input the url of the website you want to test.
            You can use equa11y on either a deployed website or a website hosted locally.
          </p>
        </div>
        <div className="mainChild">
          <h2>equa11y In Action</h2>
          <p>
            When you first run npx equa11y you will be greated by a simple UI. Here you can input a
            deployed or locally hosted website. Note: please include "http://" before any deployed
            website. You can manually test different end points of your application by providing it
            in the url.
          </p>
          <img src={equa11y} height="600" width="900"></img>
          <p>
          ...
          <img src={equa11ypage1} height="600" width="900"></img>
          <p>
          ...
          <img src={errortype} height="600" width="900"></img>
          <p>
          ...
          <img src={sublevel} height="700" width="900"></img>
          <p>
          ...
          <img src={manualtesting} height="800" width="900"></img>
        </div>
      </div>
    </div>
  );
